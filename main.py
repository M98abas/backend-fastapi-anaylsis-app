...
async def result_data(file: UploadFile = File(...)):
    ...
    df2 = pd.DataFrame(datafetched.groupby(['ReturnCode','Bin','AccountNumberLast4','UniqueId','AccountHolder','RequestTimestamp','ChannelName','Currency','Credit','ConnectorDetails','Brand'],as_index=False)['ReturnCode'].agg({'count':'count'}))
